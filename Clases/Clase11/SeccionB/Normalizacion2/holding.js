...
// console.log(JSON.stringify(nomralizedData, null, "\t"));
console.log("data normalizada",JSON.stringify(normalizedData, null, "\t").length);

const normalData = denormalize(normalizedData.result,holdingSchema,normalizedData.entities);
// console.log(JSON.stringify(normalData, null, "\t"));
console.log("data original",JSON.stringify(normalData, null, "\t").length);
